...
#define __PYX_HAVE___ranked_completer
#define __PYX_HAVE_API___ranked_completer
...
#include "../lib/dawgdic/ranked-completer.h"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from '_ranked_completer' */
#define __Pyx_MODULE_NAME "_ranked_completer"
int __pyx_module_is_main__ranked_completer = 0;

/* Implementation of '_ranked_completer' */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_ranked_completer(void); /*proto*/
PyMODINIT_FUNC init_ranked_completer(void)
#else
PyMODINIT_FUNC PyInit__ranked_completer(void); /*proto*/
PyMODINIT_FUNC PyInit__ranked_completer(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__ranked_completer(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_ranked_completer", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main__ranked_completer) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "_ranked_completer")) {
      if (unlikely(PyDict_SetItemString(modules, "_ranked_completer", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _ranked_completer", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init _ranked_completer");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
